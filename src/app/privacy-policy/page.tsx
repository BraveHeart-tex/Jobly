...
const page = () => {
  return (
    <div>
      <div className="flex items-center justify-center w-full bg-facebook h-[6rem]">
        <Logo width={"256px"} height={"256px"} />
      </div>
      <div className="lg:p-6 lg:pb-4 p-4">
        <h1 className="scroll-m-20 text-4xl font-bold tracking-tight lg:text-4xl text-facebook dark:text-foreground">
          Privacy Policy
        </h1>
        <p className="text-muted-foreground">Last updated: February 04, 2024</p>
      </div>
      <div className="lg:p-6 lg:shadow lg:border mx-4 lg:mx-6 rounded-md">
        ...
        <h2 className="text-3xl my-2">Interpretation and Definitions</h2>
        ...
        <p className="text-foreground">For the purposes of this Privacy Policy:</p>
        <ul className="list-disc p-6 space-y-2">
          ...
          <li>
            <p className="text-foreground">
              ...
              &quot;Our&quot; in this Agreement) refers to Jobly.
            </p>
          </li>
          <li>
            <p className="text-foreground">
          ...
          <li>
            <p className="text-foreground">
              <strong>Website</strong> refers to Jobly, accessible from{" "}
              <Link
                href="https://jobly.borakaraca.tech"
                rel="external nofollow noopener"
                target="_blank"
                className="underline"
              >
                https://jobly.borakaraca.tech
              </Link>
            </p>
          </li>
          <li>
        ...
        <h2 className="text-3xl my-2">Collecting and Using Your Personal Data</h2>
        ...
        <ul className="list-disc p-6 space-y-2">
          <li>
            <p className="text-foreground">Email address</p>
          </li>
          <li>
            <p className="text-foreground">First name and last name</p>
          </li>
          <li>
            <p className="text-foreground">Usage Data</p>
          </li>
        </ul>
        <h4 className="text-xl">Usage Data</h4>
        <p className="text-foreground">Usage Data is collected automatically when using the Service.</p>
        <p className="text-foreground">
        ...
        <p className="text-foreground">We use both Session and Persistent Cookies for the purposes set out below:</p>
        <ul className="list-disc p-6 space-y-2">
          <li>
            <p className="text-foreground">
              <strong>Necessary / Essential Cookies</strong>
            </p>
            <p className="text-foreground">Type: Session Cookies</p>
            <p className="text-foreground">Administered by: Us</p>
            <p className="text-foreground">
          ...
          <li>
            ...
            <p className="text-foreground">Type: Persistent Cookies</p>
            <p className="text-foreground">Administered by: Us</p>
            <p className="text-foreground">
        ...
        <p className="text-foreground">The Company may use Personal Data for the following purposes:</p>
        <ul className="list-disc p-6 space-y-2">
          <li>
            <p className="text-foreground">
        ...
        <p className="text-foreground">We may share Your personal information in the following situations:</p>
        <ul className="list-disc p-6 space-y-2">
          <li>
        ...
        <h2 className="text-3xl my-2">Children's Privacy</h2>
        <p className="text-foreground">
        ...
        <h2 className="text-3xl my-2">Links to Other Websites</h2>
        <p className="text-foreground">
        ...
        <h2 className="text-3xl my-2">Changes to this Privacy Policy</h2>
        <p className="text-foreground">
        ...
        <h2 className="text-3xl my-2">Contact Us</h2>
        <p className="text-foreground">If you have any questions about this Privacy Policy, You can contact us:</p>
        <ul className="list-disc p-6 space-y-2">
          <li>
            By email:{" "}
            <Link
              className="underline"
              href="mailto:kahveciosman2121@hotmail.com"
              rel="external nofollow noopener"
              target="_blank"
            >
              kahveciosman2121@hotmail.com
            </Link>
          </li>
        </ul>
      </div>
