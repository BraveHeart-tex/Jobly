"use client";
import CvBuilderPersonalDetailsSection from "@/app/home/candidate/tools/_components/CvBuilderPersonalDetailsSection";
import CvBuilderProfessionalSummarySection from "@/app/home/candidate/tools/_components/CvBuilderProfessionalSummarySection";
import CvBuilderSkillsSection from "@/app/home/candidate/tools/_components/CvBuilderSkillsSection";
import CvBuilderWebsitesAndLinks from "@/app/home/candidate/tools/_components/CvBuilderWebsitesAndLinks";
import DocumentBuilderHeader from "@/app/home/candidate/tools/_components/DocumentBuilderHeader";
import DocumentBuilderViewToggle from "@/app/home/candidate/tools/_components/DocumentBuilderViewToggle";
import SectionsDndContext from "@/app/home/candidate/tools/_components/SectionsDndContext";
...
const DocumentBuilderPanel = () => {
	...
	const renderSection = (section: DocumentSection) => {
		...
		return (
			sectionsByTag[section.internalSectionTag as INTERNAL_SECTION_TAG] ??
			null
		);
	};
