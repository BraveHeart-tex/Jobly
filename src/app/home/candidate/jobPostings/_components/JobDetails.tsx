		...
		>
			<div className="flex items-center justify-between mb-4">
				<Button
					...
					className={cn(
						"hidden",
						view === "jobDetails" && "flex lg:hidden",
					)}
			...
			<div className="mt-12">
				<div className="grid gap-2">
					...
					<p className="text-foreground/90">
						...
						elit. Beatae cupiditate, delectus eveniet molestias
						ullam vel velit. A aperiam consectetur, cupiditate,
						deleniti dignissimos eos est hic, iure iusto laboriosam
						laborum maxime mollitia nisi optio perferendis
						praesentium quam quibusdam repellat sapiente sunt totam
						veniam voluptate. Debitis excepturi id nam numquam
						perferendis, rerum.
					</p>
				</div>
				<div className="grid gap-2">
