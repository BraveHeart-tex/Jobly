...
import { useDeleteSection } from "@/features/candidate/document-builder/hooks/useDeleteSection";
...
const EditableSectionTitle = React.memo(
  ({
    containerClassName,
    labelClassName,
    section,
...
EditableSectionTitle.displayName = "EditableSectionTitle";
