"use client";
import CvBuilderPersonalDetailsSection from "@/components/tools/CvBuilderPersonalDetailsSection";
import CvBuilderProfessionalSummarySection from "@/components/tools/CvBuilderProfessionalSummarySection";
import CvBuilderSkillsSection from "@/components/tools/CvBuilderSkillsSection";
import CvBuilderWebsitesAndLinks from "@/components/tools/CvBuilderWebsitesAndLinks";
import DocumentBuilderHeader from "@/components/tools/DocumentBuilderHeader";
import DocumentBuilderViewToggle from "@/components/tools/DocumentBuilderViewToggle";
import SectionsDndContext from "@/components/tools/SectionsDndContext";
